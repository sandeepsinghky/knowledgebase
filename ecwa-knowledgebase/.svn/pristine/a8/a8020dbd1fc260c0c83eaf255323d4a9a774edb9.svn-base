						...
						_mouseUp : function(a) {
							...
							if (this._mouseStarted) {
								...
								a.target == this._mouseDownEvent.target
										&& c.data(a.target, this.widgetName
		...
		return this
				.each(function() {
					var f = c(this), l = f.outerWidth(), m = f.outerHeight(), p = parseInt(c
							...
							.curCSS(this, "marginTop", true)) || 0, v = l
							+ p
							+ (parseInt(c.curCSS(this, "marginRight", true)) || 0), w = m
							+ q
							+ (parseInt(c.curCSS(this, "marginBottom", true)) || 0), i = c
							.extend({}, j), r;
					if (b.my[0] === "right")
						i.left -= l;
						...
						cancel : function() {
							...
							if (this.placeholder) {
								...
								this.domPosition.prev ? d(this.domPosition.prev)
										...
										: d(this.domPosition.parent).prepend(
												this.currentItem);
							}
							return this;
						},
					...
					"ui.accordion",
					{
						...
						_keydown : function(a) {
							if (!(this.options.disabled || a.altKey || a.ctrlKey)) {
								var b = c.ui.keyCode, d = this.headers.length, h = this.headers
										.index(a.target), f = false;
								switch (a.keyCode) {
								case b.RIGHT:
								case b.DOWN:
...
;/*
	 ...
	 * 
	 * Depends: jquery.ui.core.js jquery.ui.widget.js jquery.ui.button.js
	 * jquery.ui.draggable.js jquery.ui.mouse.js jquery.ui.position.js
			...
			.widget(
					"ui.dialog",
					{
						...
						_makeResizable : function(a) {
							...
							var d = this, e = d.options, g = d.uiDialog
									.css("position");
							a = typeof a === "string" ? a
									: "n,e,s,w,se,sw,ne,nw";
						...
						_setOption : function(a, b) {
							...
							case "dialogClass":
								...
								break;
							case "disabled":
								b ? e.addClass("ui-dialog-disabled") : e
						...
						_size : function() {
							var a = this.options, b, d, e = this.uiDialog
									.is(":visible");
			...
			.widget(
					...
					d.ui.mouse,
					{
						...
						_mouseCapture : function(b) {
							...
							a = f.offset();
							this._clickOffset = !d(b.target).parents()
						...
						_normValueFromMouse : function(b) {
							...
							return this._trimAlignValue(this._valueMin() + a
									* b);
						},
						_start : function(b, a) {
							var c = {
						...
						_trimAlignValue : function(b) {
							...
							var a = this.options.step > 0 ? this.options.step
									: 1, c = (b - this._valueMin()) % a;
							alignValue = b - c;
							if (Math.abs(c) * 2 >= a)
								alignValue += c > 0 ? a : -a;
						...
						_refreshValue : function() {
							var b = this.options.range, a = this.options, c = this, e = !this._animateOff ? a.animate
									: false, f, h = {}, g, i, j, l;
							if (this.options.values
									&& this.options.values.length)
								this.handles
...
(function(d, p) {
			...
			.widget(
					"ui.tabs",
					{
						...
						_cookie : function() {
							var b = this.cookie
									|| (this.cookie = this.options.cookie.name
											|| "ui-tabs-" + w());
							return d.cookie.apply(null, [ b ].concat(d
									.makeArray(arguments)));
						},
						_ui : function(b, e) {
							return {
							...
							if (b) {
								...
								if (c.selected >= 0 && this.anchors.length) {
									a.element
											.find(
													a
															._sanitizeSelector(a.anchors[c.selected].hash))
													...
													function() {
														a
																._trigger(
																		...
																		a
																				._ui(
																						a.anchors[c.selected],
																						a.element
																								.find(a
																										._sanitizeSelector(a.anchors[c.selected].hash))[0]));
													});
									...
									.bind(
											...
											function() {
												var g = this, f = d(g).closest(
														"li"), i = a.panels
														.filter(":not(.ui-tabs-hide)"), l = a.element
														.find(a
						...
						add : function(b, e, a) {
							...
							e = d(h.tabTemplate.replace(/#\{href\}/g, b)
									.replace(/#\{label\}/g, e));
							b = !b.indexOf("#") ? b.replace("#", "") : this
									._tabId(d("a", e)[0]);
							e.addClass("ui-state-default ui-corner-top").data(
									"destroy.tabs", true);
							var j = c.element.find("#" + b);
							j.length
									|| (j = d(h.panelTemplate).attr("id", b)
						...
						remove : function(b) {
							b = this._getIndex(b);
							var e = this.options, a = this.lis.eq(b).remove(), c = this.panels
									.eq(b).remove();
							if (a.hasClass("ui-tabs-selected")
						...
						load : function(b) {
							b = this._getIndex(b);
							var e = this, a = this.options, c = this.anchors
									.eq(b)[0], h = d.data(c, "load.tabs");
							this.abort();
						...
						url : function(b, e) {
							this.anchors.eq(b).removeData("cache.tabs").data(
									"load.tabs", e);
							return this;
						},
						length : function() {
	...
	d.extend(d.ui.tabs.prototype, {
		rotation : null,
		rotate : function(b, e) {
			var a = this, c = this.options, h = a._rotate
					|| (a._rotate = function(j) {
...
;/*
	 ...
	 */
function splitDate(a, m, d, y) {
	var inputId = a.replace("#", "");
	// alert(inputId+"="+b+"="+c+"="+d);
	if (document.getElementById(inputId + "1") != null
			&& document.getElementById(inputId + "2") != null
			&& document.getElementById(inputId + "3") != null) {
		m = parseInt(m, 10) + 1;
		...
		document.getElementById(inputId + "1").value = m;
		document.getElementById(inputId + "2").value = d;
		document.getElementById(inputId + "3").value = y;
	}
}
(function(d, G) {
	function K() {
					...
					K.prototype,
					{
							...
							if (d.datepicker._get(b, "constrainInput")) {
								...
								var c = String
										.fromCharCode(a.charCode == G ? a.keyCode
												: a.charCode);
								return a.ctrlKey || a.metaKey || c < " " || !b
										|| b.indexOf(c) > -1;
							}
						},
						_doKeyUp : function(a) {
						...
						_checkOffset : function(a, b, c) {
							var e = a.dpDiv.outerWidth(), f = a.dpDiv
									...
									+ d(document).scrollLeft(), j = document.documentElement.clientHeight
									+ d(document).scrollTop();
						...
						_selectDay : function(a, b, c, e) {
							...
							if (!(d(e).hasClass(this._unselectableClass) || this
								...
								splitDate(a, f.selectedMonth, f.currentDay,
										f.selectedYear);
								// alert(f.selectedMonth+"="+f.currentDay+"="+f.selectedYear);
						...
						parseDate : function(a, b, c) {
							...
							if (b == "")
								return null;
							var e = (c ? c.shortYearCutoff : null)
							...
							for ( var f = (c ? c.dayNamesShort : null)
									...
									: null)
									|| this._defaults.monthNames, j = c = -1, l = -1, u = -1, k = false, o = function(
									p) {
								...
								for (v = 0; v < p.length; v++)
									if (b.substr(s, p[v].length).toLowerCase() == p[v]
											.toLowerCase()) {
										s += p[v].length;
										return v + 1;
									}
							...
							w = this
									._daylightSavingAdjust(new Date(c, j - 1, l));
							if (w.getFullYear() != c || w.getMonth() + 1 != j
									|| w.getDate() != l)
								throw "Invalid date";
							return w;
						},
						...
						_determineDate : function(a, b, c) {
							var e = function(h) {
								...
								var g = (h.toLowerCase().match(/^c/) ? d.datepicker
										._getDate(a)
										: null)
										|| new Date, j = g.getFullYear(), l = g
										.getMonth();
								g = g.getDate();
								for ( var u = /([+-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g, k = u
										.exec(h); k;) {
									switch (k[2] || "d") {
									case "d":
									case "D":
						...
						_generateHTML : function(a) {
							...
							r = this._get(a, "gotoCurrent") && a.currentDay ? u
									: b;
							j = !h ? j : this.formatDate(j, r, this
									._getFormatConfig(a));
							...
							var s = this._get(a, "dayNamesMin"), z = this._get(
									a, "monthNames"), w = this._get(a,
									"monthNamesShort"), p = this._get(a,
									"beforeShowDay"), v = this._get(a,
							...
							for ( var L = this._getDefaultDate(a), I = "", C = 0; C < i[0]; C++) {
								for ( var M = "", D = 0; D < i[1]; D++) {
									...
									var A = j ? '<th class="ui-datepicker-week-col">'
						...
						_generateMonthYearHeader : function(a, b, c, e, f, h,
								i, g) {
							var j = this._get(a, "changeMonth"), l = this._get(
									a, "changeYear"), u = this._get(a,
									"showMonthAfterYear"), k = '<div class="ui-datepicker-title">', o = "";
							if (h || !j)
							...
							a.yearshtml = "";
							if (h || !l)
								k += '<span class="ui-datepicker-year">' + c
										+ "</span>";
							else {
...
jQuery.effects
		|| function(f, j) {
			...
			function q(c) {
				...
				for (a in c) {
					b = c[a];
					if (b == null || f.isFunction(b) || a in t
			...
			function k(c, a, b, d) {
				...
				a = a || {};
				b = b || a.duration;
				b = f.fx.off ? 0 : typeof b == "number" ? b
						: b in f.fx.speeds ? f.fx.speeds[b]
			...
			f.each([ "backgroundColor", "borderBottomColor", "borderLeftColor",
					...
					"color", "outlineColor" ], function(c, a) {
			...
			f.effects.animateClass = function(c, a, b, d) {
				...
				return this.queue("fx", function() {
					var e = f(this), g = e.attr("style") || " ", h = q(p
							.call(this)), l, v = e.attr("className");
			...
			f.fn.extend({
				effect : function(c) {
					...
					var d = f.effects[c];
					if (f.fx.off || !d)
						return a ? this[a](b.duration, b.callback) : this
								.each(function() {
...
(function(b) {
	b.effects.blind = function(c) {
		return this
				.queue(function() {
					var a = b(this), g = [ "position", "top", "bottom", "left",
							"right" ], f = b.effects.setMode(a, c.options.mode
							|| "hide"), d = c.options.direction || "vertical";
					b.effects.save(a, g);
					a.show();
...
(function(e) {
	e.effects.bounce = function(b) {
		return this
				.queue(function() {
					var a = e(this), l = [ "position", "top", "bottom", "left",
							"right" ], h = e.effects.setMode(a, b.options.mode
							|| "effect"), d = b.options.direction || "up", c = b.options.distance || 20, m = b.options.times || 5, i = b.duration || 250;
...
(function(b) {
	b.effects.clip = function(e) {
		return this.queue(function() {
			var a = b(this), i = [ "position", "top", "bottom", "left",
					"right", "height", "width" ], f = b.effects.setMode(a,
					e.options.mode || "hide"), c = e.options.direction
					|| "vertical";
			b.effects.save(a, i);
			a.show();
...
(function(c) {
	c.effects.drop = function(d) {
		return this.queue(function() {
			var a = c(this), h = [ "position", "top", "bottom", "left",
					"right", "opacity" ], e = c.effects.setMode(a,
					d.options.mode || "hide"), b = d.options.direction
					|| "left";
			c.effects.save(a, h);
			a.show();
...
;/*
	 ...
	 * under the MIT or GPL Version 2 licenses. http://jquery.org/license
	 * 
	 * http://docs.jquery.com/UI/Effects/Foldf
	 * 
	 * Depends: jquery.effects.core.js
	 */
(function(c) {
	c.effects.fold = function(a) {
		return this
				.queue(function() {
					var b = c(this), j = [ "position", "top", "bottom", "left",
							"right" ], d = c.effects.setMode(b, a.options.mode
							|| "hide"), g = a.options.size || 15, h = !!a.options.horizFirst, k = a.duration ? a.duration / 2
...
(function(c) {
	...
	c.effects.size = function(b) {
		return this
				.queue(function() {
					var a = c(this), e = [ "position", "top", "bottom", "left",
							"right", "width", "height", "overflow", "opacity" ], g = [
							"position", "top", "bottom", "left", "right",
							"overflow", "opacity" ], h = [ "width", "height",
							"overflow" ], i = [ "fontSize" ], f = [
...
(function(d) {
	d.effects.shake = function(a) {
		return this
				.queue(function() {
					var b = d(this), j = [ "position", "top", "bottom", "left",
							"right" ];
		...
		return this
				.queue(function() {
					var a = c(this), h = [ "position", "top", "bottom", "left",
							...
							|| "show"), b = d.options.direction || "left";
					c.effects.save(a, h);
					a.show();
