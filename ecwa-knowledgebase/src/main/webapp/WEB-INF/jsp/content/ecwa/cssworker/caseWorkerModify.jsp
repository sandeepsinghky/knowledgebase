...
$(document).ready(function() {
	...
	$('#UpdateDB').click(function() {
		...
		$("#errorCaseWorker").hide();
		if (!validateDate()){
			 errorMessage = errorMessage +"<li>"  + "Invalid Hire date. "+ "</li>";
		}
...
function validateDate(){
	 ...
	 var dtArray = inDate.match(rxDatePattern);  
...
<form name="updateDBWorker" id="updateDBWorker" method="post"	modelAttribute="caseWorker" action="${pageContext.request.contextPath}/cswp/user/updateDBWorker.htm">
		 ...
		 <table class="caseWorkerModifyTable">
			 ...
			 <div>
				<table width="70%" border="0">
					<tr>
					<td align="center"><input type=button id="UpdateDB" value='Submit'></td>
